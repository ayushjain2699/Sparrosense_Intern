...
def C3D(input, dimensions, dropout=False, regularizer=True):
    ...
    with tf.variable_scope('C3D'):
        ...
        reshaped = tf.reshape(maxpool_5, [-1, nodes], name = 'reshaped')  # pool_shape[0] is N, batch_size
        ...
        with tf.variable_scope('fc8'):  # fc8
            ...
            out1 = tf.matmul(fc7, out_weight)
            out = tf.add(out1, out_bias, name = 'out')  # DO NOT ADD RELU!!!
